...
//#pragma comment(lib,"C:/Program Files (x86)/Windows Kits/10/Lib/10.0.22000.0/um/arm/Comdlg32.lib");
//#pragma comment(lib,"C:/Program Files (x86)/Windows Kits/10/Lib/10.0.22000.0/um/arm/Ole32.lib");
